This repository contains the Julia code asoociated with the [paper](https://arxiv.org/abs/2404.04054) "Constructive proofs for some semilinear PDEs on $H^2(e^{|x|^2/4},\mathbb{R}^d)$".
